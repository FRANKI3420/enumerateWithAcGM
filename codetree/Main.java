...
class Main {
    ...
    private static int PARAM = Integer.MAX_VALUE;// 8:300 9:5000
    ...
    public static void main(String[] args) {
        ...
        try {
            if (!PARALLEL) {
                ...
                startEnumarateParallel(USING_STACK);
            }
            fileClose();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private static void startEnumarateParallel(boolean USING_STACK) throws IOException {
...
// private static CompletableFuture<Void>
// enumarateWithAcGMParallel(ExecutorService executorService,
// ArrayList<ObjectFragment> codeList, ArrayList<ObjectFragment> pastFragments)
// {
// List<CompletableFuture<Void>> tasks = new ArrayList<>();// 非同期タスクの管理
// UpdatamaxMemoryUsed(codeList);
...
// continue;
// }
// ArrayList<ObjectFragment> childrenOfM1 = getChildrenOfM1(codeList, index,
// c.getVlabel());
...
// enumerateWithAcGMParallelUsingStack(ExecutorService executorService,
// ArrayList<ObjectFragment> codeList,
// ArrayList<ObjectFragment> pastFragments) {
// ConcurrentLinkedDeque<Frame> stack = new ConcurrentLinkedDeque<>();
...
// private static CompletableFuture<Void> processStack(ExecutorService
// executorService,
// ConcurrentLinkedDeque<Frame> stack) {
// List<CompletableFuture<Void>> tasks = new ArrayList<>();
...
// if (c != null && c.getIsConnected()) {
// ArrayList<ObjectFragment> nowFragments = new
// ArrayList<>(currentPastFragments);
// nowFragments.add(c);
...
// public static void enumerateWithAcGMUsingForkJoin(ArrayList<ObjectFragment>
// codeList,
...
// EnumerationTask(ArrayList<ObjectFragment> currentList,
// ArrayList<ObjectFragment> currentPastFragments) {
...
// ArrayList<ObjectFragment> childrenOfM1 = getChildrenOfM1(currentList, index,
// c.getVlabel());
